...
const LightPillar = ({
  ...
  useEffect(() => {
    ...
    // Fragment shader con mezcla con color de fondo
    const fragmentShader = `
      ...
      uniform vec3 uBgColor;        // NUEVO: color de fondo
      ...
      void main() {
        ...
        // Mezcla con color de fondo para evitar corte duro
        float brightness = length(color);
        float mixFactor = clamp(brightness * 2.0, 0.0, 1.0);
        vec3 finalColor = mix(uBgColor, color, mixFactor);
    ...
    const material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uBgColor: { value: new THREE.Color('#232036') },
